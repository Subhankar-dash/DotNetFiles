...
{ 
    public class InfoDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Doctor(){ StaffId=1 , Name= "sk" , StaffCategory = "doctor" , Contact = 567 , Department = "heart" , Education ="mbbs" , fees = 56 , PatienceCount = 10}
            };
            var nurse = new Nurse[]
            {
                new Nurse()
                {
                    StaffId = 2,
                    Name = "fg",
                     StaffCategory = "nurse" , Contact = 567 , Department = "heart" , Education ="bbs" , fees = 56 , RoomCount = 10
            ...
            {
                new Technician() { StaffId=3, Name= "ghj", fees = 45, Education ="ghj", Department = "heart" , Contact = 567 , MachineCount = 7 , StaffCategory ="technician" }
            };



            //var Staffs = doctor.Cast<Staff>()
            //    .Union(technician)
            //    .Union(nurse)
            //    .ToList();
            ...
            modelBuilder.Entity<Technician>().HasData(technician);
